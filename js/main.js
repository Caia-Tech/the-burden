...
function toggleTheme() {
    // Since we're dark by default, just toggle visibility features
    const currentVisibility = document.body.classList.contains('high-contrast');
    document.body.classList.toggle('high-contrast');
    localStorage.setItem('highContrast', !currentVisibility);
}
...
function updateThemeIcon() {
    ...
    if (themeIcon) {
        themeIcon.textContent = document.body.classList.contains('high-contrast') ? '👁' : '🌙';
    }
}
